...
//vendor
export const ADD_VENDORDETAILS_SUCCESS_ACTION = "ADD_VENDORDETAILS_SUCCESS_ACTION";
export const ADD_VENDORDETAILS_FAILURE_ACTION = "ADD_VENDORDETAILS_FAILURE_ACTION";
export const FETCH_VENDOR_SUCCESS_ACTION = "FETCH_VENDOR_SUCCESS_ACTION";
export const FETCH_VENDOR_FAILURE_ACTION = "FETCH_VENDOR_FAILURE_ACTION";
export const FETCH_AUDITOR_SUCCESS_ACTION = "FETCH_AUDITOR_SUCCESS_ACTION";
export const FETCH_AUDITOR_FAILURE_ACTION = "FETCH_AUDITOR_FAILURE_ACTION";
export const SAVE_VENDORDETAILS_SUCCESS_ACTION = "SAVE_VENDORDETAILS_SUCCESS_ACTION";
export const SAVE_VENDORDETAILS_FAILURE_ACTION = "SAVE_VENDORDETAILS_FAILURE_ACTION";
export const SET_CURRENT_VENDOR = "SET_CURRENT_VENDOR";
export const DELETE_VENDORDETAILS_SUCCESS_ACTION = "DELETE_VENDORDETAILS_SUCCESS_ACTION";
export const DELETE_VENDORDETAILS_FAILURE_ACTION = "DELETE_VENDORDETAILS_FAILURE_ACTION";
